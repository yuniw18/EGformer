...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', help = 'Structure3D Data_path' , type=str, default='')
    ...
    parser.add_argument('--save_sample', help= 'save sample results as image if true', action='store_true')
    parser.add_argument('--output_path', help = 'folder path where samples will be saved' , type=str, default='output')
    parser.add_argument('--output_json_path', help = 'folder path where json formatted output will be saved' , type=str, default='output_json')
