...
from models.Panoformer.PSA import *

from models.Panoformer.equisamplingpoint import genSamplingPattern
...
class Panoformer(nn.Module):
    def __init__(self, img_size=256, in_chans=3,
        ...
        self.output_layout = OutputProj(in_channel=2 * embed_dim, out_channel=3, kernel_size=3, stride=1,
                                      input_resolution=(img_size, img_size * 2))
        curr_dim = 32
#        self.output_conv_layout = nn.Sequential(
...
#        )
    ...
    def forward(self, x):
        ...
        feature = self.output_layout(deconv3)
